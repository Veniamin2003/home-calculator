...
function WindowTypeItem(props) {
    ...
    return (
        <div key={props.id} className={containerTypeClass} onClick={() => props.updateWindowType(props.price, props.id, props.name)}>
